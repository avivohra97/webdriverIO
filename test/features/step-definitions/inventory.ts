...
Then(/^Inventory page should (.*)\s?list (.*)$/, async function (negativeCheck, noOfProducts) {
    try {
        ...
        err.message = `Failed when comparing product count, ${err.message}`
        // throw err // Failing
